	...
	function ($) {
		...
		$( document.body ).on(
			...
			function () {
				...
				$( '.daextlnl-main-form__daext-form-section-body[data-section-id="' + target + '"]' ).toggleClass( 'daextlnl-main-form__daext-form-section-body-opened' );
		...
		$( document.body ).on(
			'mouseenter',
			'.daextlnl-admin-toolbar__menu-item-more',
			function () {
				$( '.daextlnl-admin-toolbar__pop-sub-menu' ).show();
			}
		);

		$( document.body ).on(
			'mouseleave',
			'.daextlnl-admin-toolbar__menu-item-more, .daextlnl-admin-toolbar__pop-sub-menu',
			function () {
				$( '.daextlnl-admin-toolbar__pop-sub-menu' ).hide();
			}
		);
		...
		$( document ).on(
			'change',
			'.daextlnl-bulk-action-checkbox',
			function () {
				let selectedItems = [];
				$( '.daextlnl-bulk-action-checkbox:checked' ).each(
					function () {
