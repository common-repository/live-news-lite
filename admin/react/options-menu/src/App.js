...
const App = () => {
  ...
  useEffect(() => {
     ...
     */
    wp.apiFetch({
      path: '/live-news-lite/v1/read-options',
      method: 'POST'
    }).
        then(data => {
  ...
  function handleSave(e) {
    ...
    wp.apiFetch({
      path: '/live-news-lite/v1/options',
      method: 'POST',
      data: {
        ...options
      },
        ...
        <React.StrictMode>

          {
            ...
            <>
              ...
              <div className="daextlnl-body-container">
            ...
            :
            <LoadingScreen
                loadingDataMessage={__('Loading data...', 'live-news-lite')}
            />
        }
